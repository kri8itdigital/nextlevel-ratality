...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			'key' => 'field_6411b18e5554e',
			'label' => 'RATALITY Enable Timer',
			'name' => 'ratality_enable_timer',
			'aria-label' => '',
			'type' => 'true_false',
			'instructions' => '',
			'required' => 1,
		...
		array(
			'key' => 'field_6411b1ae5554f',
			'label' => 'RATALITY Timer Length',
			'name' => 'ratality_timer_length',
			'aria-label' => '',
			'type' => 'number',
			'instructions' => '',
			'required' => 1,
		...
		array(
			'key' => 'field_6413274d469b8',
			'label' => 'RATALITY Booking Session Expired Title',
			'name' => 'ratality_booking_session_expired_title',
			'aria-label' => '',
			'type' => 'text',
			'instructions' => '',
			'required' => 1,
		...
		array(
			'key' => 'field_64132771469b9',
			'label' => 'RATALITY Booking Session Expired Text',
			'name' => 'ratality_booking_session_expired_text',
			'aria-label' => '',
			'type' => 'wysiwyg',
			'instructions' => '',
			'required' => 1,
		...
		array(
			'key' => 'field_6413278e469ba',
			'label' => 'RATALITY Booking Session Button Text',
			'name' => 'ratality_booking_session_button_text',
			'aria-label' => '',
			'type' => 'text',
			'instructions' => '',
			'required' => 1,
		...
		array(
			'key' => 'field_6413279e469bb',
			'label' => 'RATALITY Booking Session Button Link',
			'name' => 'ratality_booking_session_button_link',
			'aria-label' => '',
			'type' => 'text',
			'instructions' => '',
			'required' => 1,
		...
		array(
			'key' => 'field_641327be469bc',
			'label' => 'RATALITY Booking Session Homepage Timeout',
			'name' => 'ratality_booking_session_homepage_timeout',
			'aria-label' => '',
			'type' => 'number',
			'instructions' => '',
			'required' => 1,
		...
		array(
			'key' => 'field_6411b1d1aafcb',
			'label' => 'RATALITY Order Button Text',
			'name' => 'ratality_order_button_text',
			'aria-label' => '',
			'type' => 'text',
			'instructions' => '',
			'required' => 1,
			...
			'default_value' => 'Confirm Tickets and Pay',
			'maxlength' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array(
			'key' => 'field_6411b201aafcc',
			'label' => 'RATALITY Cancel Button Text',
			'name' => 'ratality_cancel_button_text',
			'aria-label' => '',
			'type' => 'text',
			'instructions' => '',
			'required' => 1,
			...
			'default_value' => 'Cancel and start again',
			'maxlength' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array(
			'key' => 'field_6411b235aafcd',
			'label' => 'RATALITY Terms and Conditions',
			'name' => 'ratality_terms_and_conditions',
			'aria-label' => '',
			'type' => 'file',
			'instructions' => '',
			'required' => 1,
	...
	/* UNDO TICKET SELECTION */
	public function ratality_ajax_destroy_everything(){
	...
	/* UNDO TICKET SELECTION */
	public function ratality_ajax_reset_search(){
		...
		if(function_exists('WC')):
			...
			if(WC()->session->get('ratality_pickup_location')):
				...
				if(RATALITY_HELPERS::IS_SEARCH_PAGE($_POST['object_id']) || RATALITY_HELPERS::IS_TICKET_PAGE($_POST['object_id']) || is_checkout() || is_shop()):
