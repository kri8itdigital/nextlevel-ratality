...
class Nextlevel_Ratality_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/nextlevel-ratality-public.js', array( 'jquery', 'google/html', 'confirm/js', 'jquery/datepicker/js'  ), $this->version, false );
	...
	public function ratality_search_form(){
		...
		<div id="RATALITYSEARCHCONTAINER">
			<form id="RATALITYSEARCHFORM">
				<div class="row">
					<div class="col-5">
						<div class="row">
							<div class="col-6">
								<div><label>Pick-Up Location</label></div>
								<select name="ratalityPickUpLocation" id="ratalityPickUpLocation">
							...
							<div class="col-6">
								...
								<select name="ratalityDropOffLocation" id="ratalityDropOffLocation">
					...
					<div class="col-5">
						<div class="row">
							<div class="col-2">								
								...
								<select name="ratalityTickets" id="ratalityTickets">
							...
							<div class="col-4">
								...
								<input type="date" name="ratalityPickUpDate" id="ratalityPickUpDate" />
							</div>
							<div class="col-2">
							...
							<div class="col-4">
								...
								<input class="ratality_disabled" type="date" name="ratalityDropOffDate" id="ratalityDropOffDate" />								
							</div>
						</div>
		...
		if(!is_admin()):
			...
			if(isset($_TRIPS['TRIPONE']) && is_array($_TRIPS['TRIPONE']) && count($_TRIPS['TRIPONE']) > 0):
				...
				foreach($_TRIPS['TRIPONE'] as $_TRIP):
					...
					RATALITY_HELPERS::OUTPUT_TRIP($_TRIP);
				...
				<div class="ratality_ticket_block">
					...
					<div class="row">
						<div class="col-4">
							...
							<select name="ratality_passengers[<?php echo $_COUNTER; ?>]['ageGroup']">
						...
						<div class="col-4">		
							<label>Gender</label>
							<select name="ratality_passengers[<?php echo $_COUNTER; ?>]['gender']">
								<option value=""></option> 
						...
						<div class="col-4">
							<label>Title</label>
							<select name="ratality_passengers[<?php echo $_COUNTER; ?>]['title']">
								<option value=""></option>
					...
					<div class="row">
						...
						<div class="col-4">
							...
							<input type="text" name="ratality_passengers[<?php echo $_COUNTER; ?>]['name']" />
						</div>
						<div class="col-4">
							<label>Last Name</label>
							<input type="text" name="ratality_passengers[<?php echo $_COUNTER; ?>]['surname']" />
						</div>
						<div class="col-4">
							<label>Travelling infant</label>
							<select name="ratality_passengers[<?php echo $_COUNTER; ?>]['travellingInfant']">
								<option value="no">No</option>
								<option value="Yes">Yes</option>
							</select>
						</div>
					...
					<div class="row">
						<div class="col-4">
								...
								<select name="ratality_passengers[<?php echo $_COUNTER; ?>]['documentType']"> 
									<option value=""></option> 
						...
						<div class="col-4">
							...
							<input type="text" name="ratality_passengers[<?php echo $_COUNTER; ?>]['documentNumber']" />
						</div>
						<div class="col-4">
							<label>Date Of Birth</label>
							<input type="date" name="ratality_passengers[<?php echo $_COUNTER; ?>]['dateOfBirth']" />
						</div>
					</div>
					...
					<div class="row">
						<div class="col-6">
							...
							<input type="email" name="ratality_passengers[<?php echo $_COUNTER; ?>]['email']" />						
						</div>
						<div class="col-6">
							<label>Mobile Number</label>
							<input type="number" name="ratality_passengers[<?php echo $_COUNTER; ?>]['mobileNumber']" />
						</div>
					</div>
					...
					<div class="row">
						<div class="col-6">
							...
							<input type="text" name="ratality_passengers[<?php echo $_COUNTER; ?>]['emergencyContactName']" />							
						</div>
						<div class="col-6">
							<label>Emergency Contact Number</label>
							<input type="number" name="ratality_passengers[<?php echo $_COUNTER; ?>]['emergencyContactNumber']" />
						</div>
					</div>
